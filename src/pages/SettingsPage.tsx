import { User, Building, FolderOpen, Globe, Users, Bell, Palette, Package, Brain, Shield, CreditCard, Database, ChevronRight } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const settingSections = [
    ...
    { icon: Database, titleKey: "recovery.title", descKey: "recovery.subtitle", path: "/settings/recovery" },
  ];
