...
import PoliciesPanel from '@/apps/safeback/components/PoliciesPanel';

export default function SafeBackPolicies() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <h2 className="text-lg font-semibold text-foreground">{t('apps.safeback.tabs.policies', 'Policies')}</h2>
      <PoliciesPanel
        settings={settings}
