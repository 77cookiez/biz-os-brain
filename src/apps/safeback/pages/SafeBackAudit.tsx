...
import AuditLogPanel from '@/apps/safeback/components/AuditLogPanel';

export default function SafeBackAudit() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <h2 className="text-lg font-semibold text-foreground">{t('apps.safeback.tabs.audit', 'Audit')}</h2>
      <AuditLogPanel />
    </div>
  );
}
